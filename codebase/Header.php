...
<header>
    ...
    <div class="container-fluid">
        <div class="navbar-brand">
            <a href="index.php"><img class="logo" src="../images/logo.jpeg" style="margin-left: 10px; width: 67px;"></a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="menu">
            <ul class="navbar-nav ml-auto ">
                <li class="nav-item"><a class="nav-link navbar-link nav-active" href="index.php">HOME</a></li>
